...
import airflow.utils.task_group import task_group

def download_tasks():
    with task_group("downloads",tooltip="Download tasks") as group:

        download_a=BashOperator(task_id='download_data_a',
        ...
        download_b=BashOperator(task_id='download_data_b',
